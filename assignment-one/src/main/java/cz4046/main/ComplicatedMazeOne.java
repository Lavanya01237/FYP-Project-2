...
/**
 * (Part 2)
 * ComplicatedMazeEnv1stCase class is executable file to run the Complicated
 * Maze Environment (1st Case: Each category of states (Penalty, Reward, Wall)
 * has an equal number of states)
 */
public class ComplicatedMazeOne {
    ...
    public static void main(String[] args) {
        ...
        // for Bonus Question
        // 1 - means it will use the coordinates defined for maze environment (1st case)
        ...
        WriteToFile.writeToFile(valueIteration.getUtilityEstimates(), scale, "results/",
                "part2_1stCase_value_iteration_utility_estimates");
        ...
        WriteToFile.writeToFile(policyIteration.getUtilityEstimates(), scale, "results/",
                "part2_1stCase_policy_iteration_utility_estimates");
