...
import static cz4046.methods.RepeatedFunctions.*;

/**
 * DisplayManager class is used to display the map and all the utilities and
 * actions in a grid format on Main.java,
 * ComplicatedMazeEnvScale.java,CompilcatedMazeEnv1stCase.java,
