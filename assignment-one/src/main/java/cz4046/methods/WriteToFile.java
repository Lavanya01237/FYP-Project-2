...
import static cz4046.main.Config.NUM_COLS;
import static cz4046.main.Config.NUM_ROWS;

/**
 * WriteToFile class is used to write all the utility estimates in the csv file
 */
public class WriteToFile {
    public static void writeToFile(List<UtilityAndAction[][]> ListOfAUArr, int scale, String directory,
            String fileName) {
