...
import cz4046.methods.RepeatedFunctions;
...
/**
 * Action class contains the transition probabilities and the actions that are
 * available for the agents to use
 */
public enum Action {
    UP("ʌ ", 0, -1) {
        public Action getClockwiseAction() {
            return RIGHT;
        }

        public Action getAntiClockwiseAction() {
            return LEFT;
        }
    },
    DOWN("v ", 0, 1) {
