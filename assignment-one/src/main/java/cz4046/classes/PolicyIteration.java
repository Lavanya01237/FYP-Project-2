...
public class PolicyIteration {
    ...
    private UtilityAndAction getSimplifiedBellmanUpdate(int row, int col,
            UtilityAndAction[][] currentUtilityAndActionArray, MazeState[][] Maze, double discount) {
    ...
    private double getExpectedUtility(UtilityAndAction[][] utilityAndActionArray, Action action, int row, int col) {
        ...
        double clockwiseUtility = getExpUtilityBasedAction(utilityAndActionArray, action.getClockwiseAction(), row,
                col);
        double antiClockwiseUtility = getExpUtilityBasedAction(utilityAndActionArray, action.getAntiClockwiseAction(),
                row, col);
    ...
    private double getExpUtilityBasedAction(UtilityAndAction[][] currenUtilityAndActionArray, Action action, int row,
            int col) {
        int ymodified = row;
        int xmodified = col;
    ...
    private UtilityAndAction getMaxUtilityAndAction(UtilityAndAction[][] currentUtilityAndActionArray, int row,
            int col) {
        List<UtilityAndAction> listOfUtilityAndAction = new ArrayList<>();

        for (Action action : Action.values()) {
            listOfUtilityAndAction.add(
                    new UtilityAndAction(action, getExpectedUtility(currentUtilityAndActionArray, action, row, col)));
        }
